...
export const get_all_article = (currentPage,searchValue)=>async(dispatch)=>{
    try {
        const response = await axios.get(`http://localhost:4000/rest-api/home-article-get?currentPage=${currentPage}&&searchValue=${searchValue}`,{withCredentials:true});
        dispatch({
...
export const get_home_tag_category = () =>async(dispatch) =>{
    try {
        const response = await axios.get('http://localhost:4000/rest-api/home/get-tag-category',{withCredentials:true});
        dispatch({
...
export const get_old_recent_acticle = () =>async(dispatch) =>{
    try {
        const response = await axios.get('http://localhost:4000/rest-api/article/recent-old-get',{withCredentials:true});
        dispatch({
...
export const get_category_article = (categorySlug,currentPage) =>async(dispatch) =>{
    try {
        const response = await axios.get(`http://localhost:4000/rest-api/category-article-get?categorySlug=${categorySlug}&&currentPage=${currentPage}`,{withCredentials:true});
        dispatch({
...
export const get_tag_article = (tagSlug,currentPage) =>async(dispatch) =>{
    try {
        const response = await axios.get(`http://localhost:4000/rest-api/tag-article-get?tagSlug=${tagSlug}&&currentPage=${currentPage}`,{withCredentials:true});
        dispatch({
...
export const userView = ()=>async()=>{
    try {
        await axios.get(`http://localhost:4000/rest-api/user-view`,{withCredentials:true});
    } catch (error) {
