            ...
            <div className="title-show-article">
                ...
                <form onSubmit={update}>
                    <div className="form-group">
                        ...
                        <input type="text" onChange={inputHendle} name="categoryName" value={state.categoryName} className="form-control" placeholder="category name" id="category_name"/>
                        <p className="error">{categoryError && categoryError.categoryName}</p>
                    </div>
                    <div className="form-group">
                        <label htmlFor="category_des">Category Description</label>
                        <textarea onChange={inputHendle} name="categoryDes" value={state.categoryDes} type="text" className="form-control" placeholder="category description" id="category_des"/>
