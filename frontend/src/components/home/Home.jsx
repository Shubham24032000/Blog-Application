                                    ...
                                    <ul>
                                        {
                                            ...
                                            <li key={index}><Link to={`/artical/tag/${tag.split(' ').join('-')}`}>{tag}</Link></li>
                                            )
                                        }
                                    </ul>
                                </div>
