...
import { get_comment, user_comment, reply_comment ,comment_delete,comment_reply_delete} from '../../store/actions/home/homeCommentAction';
                ...
                />
                {
                    comment.length > 0 ? comment.map((c, index) => <div className="main-reply-comment">
                        <div className="image-comment-time-name">
                            {/* <img src="http://localhost:3000/articalImage/k.jpg"/> */}

                            <InitialsAvatar name={c.userName} className="initial-avatar" />
                            <div className="name-time-comment">
                                ...
                                <div className={show_reply === c._id ? 'reply_box show' : 'reply_box'}>
                                    <div className="image-input">
                                        ...
                                        <InitialsAvatar name={c.userName} className="initial-avatar" />
                                        <input onChange={(e) => setReplyText(e.target.value)} value={replyText} type="text" placeholder="Add a public reply" />
                                    </div>
                                ...
                                {
                                    c.replyComment.length > 0 && c.replyComment.map((rc, index) =>
                                        <div className="reply_comment">
                                            <div className="reply_comment_image_name_time">
                                                {/* <img src="http://localhost:3000/articalImage/k.jpg"/> */}

                                                <InitialsAvatar name={rc.replyName} className="initial-avatar" />
                                                <div className="name-time-comment">
                                                    <div className="name-time">
                                                        <h4>{rc.replyName}</h4>
                                                        <span>10 day ago</span>
